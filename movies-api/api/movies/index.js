...
import {getUpcomingMovies, getGenres, getMovieActors, getNowPlayingMovies, getPopularMovies, getTopRatedMovies} from '../tmdb-api';
...
router.get('/tmdb/actors', asyncHandler(async (req, res) => {
    const actors = await getMovieActors();
